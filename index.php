 ...
 do 
	 	{
			...
			//echo "</link>";
			$binu_app->add_text("quotes.php?pageNum_quoteRecordset=0&id=".$row_categoryRecordset['category_id'], $row_categoryRecordset['category_id'].") ".$row_categoryRecordset['category'],'body_text');
